        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div
              ...
              className="font-bold text-2xl cursor-pointer flex items-center font-[Poppins] text-customBlue"
            >Jitek
            </div>
              ...
              {isLogin && (
                <div className="relative inline-block text-left">
                  <div>
                    <button
                      type="button"
                      className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md hover:bg-white"
                      onMouseEnter={() => setIsOpen(!isOpen)}
                    >
                      {isLogin && (
                        <span className="text-customBlue mr-1 ">user</span>
                      )}
